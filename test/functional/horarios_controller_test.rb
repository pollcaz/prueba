...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { curso_id: @horario.curso_id, dia: @horario.dia, hora: @horario.hora, instructor_id: @horario.instructor_id, materia_id: @horario.materia_id }
    end
  ...
  test "should update horario" do
    put :update, id: @horario, horario: { curso_id: @horario.curso_id, dia: @horario.dia, hora: @horario.hora, instructor_id: @horario.instructor_id, materia_id: @horario.materia_id }
    assert_redirected_to horario_path(assigns(:horario))
  end
